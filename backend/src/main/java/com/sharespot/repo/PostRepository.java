...
public interface PostRepository extends JpaRepository<Post, Integer> {
    ...
    public static final String FIND_USER_POST = "SELECT post_id, class_big, class_small, class_who, class_where, post_lat, post_lng, image ,upload_time FROM post_table WHERE user_id = :userId order by post_id desc";
